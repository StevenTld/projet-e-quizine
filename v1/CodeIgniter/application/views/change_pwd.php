                    ...
                    <div class="most-popular">
                        ...
                        <div class="row" style = "color:white;">
                            ...
                            echo form_label('Nouveau mot de passe',);
                              echo "<br>";
                              $champ2=array('name'=>'new_pwd', 'required'=>'required');
                              echo form_input($champ2);
                              echo "<br>";
                            echo form_label('Confirmation du nouveau mot de passe',);
                            echo "<br>";
                              $champ3=array('name'=>'conf_new_pwd', 'required'=>'required');
                        ...
                        ?>
                          ...
                          <a href ="<?php $this->config->base_url();?>modifier_profil">
